  ...
  return (
    <>
      <section className="relative z-40 h-screen w-full bg-white overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center px-8 md:hidden mt-4">
          <motion.h1
          ...
          >
            ...
            <button
              ...
              className="px-7 py-3 rounded-full border border-black/15 text-black/70 font-[family-name:var(--font-jetbrains)] text-xs tracking-widest uppercase flex items-center gap-2.5"
            >
          ...
          >
            <span className="font-[family-name:var(--font-eb-garamond)] text-xs italic text-black/30">
        ...
        <div className="relative z-10 h-full hidden md:flex flex-col justify-center items-start px-12 lg:px-20 text-left w-[45%]">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.8 }}
            className="mt-8 flex flex-row items-start gap-3.5"
          >
            <a
              href="#waitlist"
        ...
        <motion.button
          ...
          transition={{ duration: 1, delay: 1.4 }}
          onClick={handleScrollDown}
          className="absolute bottom-10 left-0 right-0 z-20 hidden md:flex flex-col items-center cursor-pointer group"
        >
          <span className="font-[family-name:var(--font-eb-garamond)] text-base italic text-black/30 group-hover:text-black/50 transition-colors">
